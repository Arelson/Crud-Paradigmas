...
public class MissaoDAO {
    ...
    // Carrega a lista de missões do arquivo de texto
    public List<Missao> carregar() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(ARQUIVO))) {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                if (dados.length == 3) { // Verifica se a linha contém os dados corretos
                    String titulo = dados[0];
                    String descricao = dados[1];
                    int nivelRequestdo = Integer.parseInt(dados[2]); // Converte o nível para int
            ...
            System.out.println("Erro ao converter nível requerido para inteiro. Verifique o formato do arquivo.");
        }
        return missoes;
    }

    // Salva uma nova missão no arquivo de texto
    ...
    // Atualiza a lista de missões no arquivo de texto
    ...
    // Exclui uma missão com base no título
