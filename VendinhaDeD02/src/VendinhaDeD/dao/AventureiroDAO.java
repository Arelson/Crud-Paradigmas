    ...
    public List<Aventureiro> carregar() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(ARQUIVO))) {
            ...
            while ((linha = br.readLine()) != null) {
                String[] dados = linha.split(";"); // Supondo que os dados s�o separados por ";"
                if (dados.length == 5) { // Verifica se a linha cont�m os dados corretos
                    String nome = dados[0];
                    String login = dados[1];
                    String senha = dados[2];
                    int nivel = Integer.parseInt(dados[3]); // Converte o n�vel para int
            ...
            System.out.println("Arquivo n�o encontrado ou erro ao ler o arquivo. Criando novo arquivo.");
        } catch (NumberFormatException e) {
            System.out.println("Erro ao converter n�vel para inteiro. Verifique o formato do arquivo.");
        }
        return aventureiros;
    }
